            ...
            <div className={"transcript-semester"}>
                ...
                <div className={"semester-field1"}>
                    <div style={{borderRight: "3px solid black", width: "20%"}} className={"semester-field2"}>
                        <p style={{fontWeight: "bold", textAlign:"center"}}>Course Code</p>
                        <p>{props.field1_1}</p>
                        <p>{props.field1_2}</p>
                        <p>{props.field1_3}</p>
                        <p>{props.field1_4}</p>
                    ...
                    <div style={{borderRight: "3px solid black", width: "35%"}} className={"semester-field2"}>
                        <p style={{fontWeight: "bold", textAlign:"center"}}>Course Name</p>
                        <p>{props.field2_1}</p>
                        <p>{props.field2_2}</p>
                        <p>{props.field2_3}</p>
                        <p>{props.field2_4}</p>
                    ...
                    <div style={{borderRight: "3px solid black", width: "20%"}} className={"semester-field2"}>
                        <p style={{fontWeight: "bold", textAlign:"center"}}>Grade</p>
                        <p>{props.field3_1}</p>
                        <p>{props.field3_2}</p>
                        <p>{props.field3_3}</p>
                        <p>{props.field3_4}</p>
                    ...
                    <div className={"semester-field2"}>
                        <p style={{fontWeight: "bold", textAlign:"center", width: "20%"}}>Credit</p>
                        <p>{props.field4_1}</p>
                        <p>{props.field4_2}</p>
                        <p>{props.field4_3}</p>
                        <p>{props.field4_4}</p>
